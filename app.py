...
def configureDataBase():
    client = MongoClient("mongodb+srv://funnyPhani:<password>@cluster0-lklj4.mongodb.net/test?retryWrites=true&w=majority")
...
if __name__ == "__main__":
    app.run(port=5000,host='0.0.0.0', debug=True)# running the app on the local machine on port 8000
